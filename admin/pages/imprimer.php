...
require '../lib/php/classes/Vue_tmtDB.class.php';
...
$pdf->Cell(3.5, 1, utf8_decode('Nos produits'),0,0,'L');
//sous-titre
...
$pdf->setXY(3,2);
$pdf->cell(15,.7, utf8_decode('Tout sur la marque TMT'),0,0,'L');
...
for ($i=0;$i<$nbrG;$i++){
    ...
    $pdf->cell(5,1,$liste[$i]['NOM_PRODUIT'],0,0,'C');
    $pdf->SetXY($x +8, $y);
